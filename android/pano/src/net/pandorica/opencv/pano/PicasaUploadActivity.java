...
// TODO: This class only asks for a username once, which sucks if you pick the
// wrong one.  Maybe the share intent is all we need, or maybe we'll want to
// keep this so that we can do background uploads.
