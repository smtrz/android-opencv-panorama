...
extern "C" {
JNIEXPORT void JNICALL Java_net_pandorica_opencv_pano_PanoSurfaceView_FindFeatures(JNIEnv* env, jobject thiz, jlong addrGray, jlong addrRgba, jlong addrComp)
{
